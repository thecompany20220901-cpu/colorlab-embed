        ...
        {step === "result" && T && result && (() => {
          ...
          return (
            <div className="px-6 py-8 fade-up">
              ...
              {/* 本家＆LINE合流 */}
              <a href={MAIN_APP_URL(T.site)} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-1.5 w-full py-3 rounded text-sm mt-1 mb-2" style={{ border: `1px solid ${P.brand}`, color: P.brand, background: "white" }}>
                ちゃんと似合う色を知る → 本家診断アプリ <ArrowRight size={14} />
              </a>
              <a href={LINE_URLS[T.site]} target="_blank" rel="noreferrer" className="block w-full text-center py-3 rounded text-white text-sm font-medium mb-4" style={{ background: "#06C755" }}>
                LINEで毎週「{T.name}の勝ち色」を受け取る
              </a>
