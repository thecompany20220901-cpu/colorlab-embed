...
const Q12 = [
  { q: "Q1（肌印象）\n鏡を見て、顔の肌の色はどちらに近いですか？", img: IMG("110182/1"), A: [1, 3], B: [2, 4], a: "黄み・オークル寄り", b: "青み・ピンク寄り" },
  { q: "Q2（印象）\n友人から、良く言われる印象はどっちが近いですか？", img: IMG("110183/2"), A: [1, 2], B: [3, 4], a: "明るい・若々しい", b: "落ち着き・大人っぽい" },
  { q: "Q3（瞳）\n鏡を見て、目の色はどちらに近いですか？", img: IMG("110184/3"), A: [1, 2], B: [3, 4], a: "明るめのブラウン", b: "深いブラウン・黒" },
  { q: "Q4（唇の色み）\nすっぴんの唇の色はどっちに近いですか？", img: IMG("110185/4"), A: [1, 3], B: [2, 4], a: "オレンジ・コーラル寄り", b: "ピンク・ローズ寄り" },
  { q: "Q5（血管の色み）\n手首の血管の見え方はどっちに近いですか？", img: IMG("110186/5"), A: [1, 3], B: [2, 4], a: "緑っぽく見える", b: "青〜青紫に見える" },
  { q: "Q6（日焼け）\n日焼けすると肌色はどうなりやすいですか？", img: IMG("110187/6"), A: [1, 3], B: [2, 4], a: "小麦色に焼ける", b: "赤くなって戻る" },
  { q: "Q7（似合う色の傾向）\nどちらの色の方がしっくりきますか？", img: IMG("110188/7"), A: [1, 2], B: [3, 4], a: "明るく澄んだ色", b: "深く落ち着いた色" },
  { q: "Q8（黒を着たとき）\n黒を着たときの印象は？", img: IMG("110189/8"), A: [1, 2], B: [3, 4], a: "顔が沈む・強すぎる", b: "引き締まって見える" },
  { q: "Q9（白の比較）\n白トップスを選ぶならどっちが似合いますか？", img: IMG("110190/9"), A: [1, 2], B: [3, 4], a: "明るくクリアな白", b: "生成り・落ち着いた白" },
  { q: "Q10（金属）\nアクセサリーはどちらが似合いますか？", img: IMG("110191/10"), A: [1, 3], B: [2, 4], a: "ゴールド", b: "シルバー" },
  { q: "Q11（頬の赤み）\n運動後や寒いときの頬の色はどっちが近いですか？", img: IMG("110193/11"), A: [1, 3], B: [2, 4], a: "オレンジっぽい赤み", b: "ピンクっぽい赤み" },
  { q: "Q12（リップ）\nリップでしっくりくるのはどちらですか？", img: IMG("110194/12"), A: [1, 2], B: [3, 4], a: "明るいクリアカラー", b: "深みのあるカラー" },
  { q: "Q13（ヘアカラー）\nどっちの髪色の方が似合いますか？", img: IMG("110195/13"), A: [1, 2], B: [3, 4], a: "明るめの髪色", b: "暗め・深めの髪色" },
];
            ...
            <div className="px-8 pb-12 pt-4">
              {!tieMode ? (
                <>
                  ...
                  <img src={Q12[qi].img} alt="" onError={(e) => { e.currentTarget.style.display = "none"; }} className="w-full rounded-2xl mb-5" style={{ border: "1px solid " + C.line }} />
                ...
                <>
                  ...
                  <img src={TIE_Q.img} alt="" onError={(e) => { e.currentTarget.style.display = "none"; }} className="w-full rounded-2xl mb-5" style={{ border: "1px solid " + C.line }} />
